...
## Demo: Claude using the Banking MCP Tool

Here is Claude interacting with the Java Banking System in real-time to check an account balance:

![Claude Balance Check](https://github.com/user-attachments/assets/f18edf3b-83c0-480c-8019-b6a4587cd6d5)
